...
## Setup is only required for those who would like to practice with their own files. Simply copy your text into a test file and save in any directory. Make sure to note down the path, as it is crucial for access.  
